 ...
 <body>
     <div class=" p-8 max-w-6xl mx-auto ring-1 ring-gray-100/70">
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
             ...
             <div
                 ...
                 <div class="space-y-1 text-sm text-gray-600">
                     ...
                     <p><strong class="text-[10px]">Endereço:</strong> {{ $aluguel->cliente->endereco ?? 'Não informado' }}</p>
                 </div>
             </div>
             ...
             <div
                 ...
                 <div class="space-y-1 text-sm text-gray-600">
                     <p><strong class="text-[10px]">Empresa:</strong> LocSilva Locações LTDA</p>
                     <p><strong class="text-[10px]">CNPJ:</strong> 11.111.111/0001-11</p>
                     <p><strong class="text-[10px]">Telefone:</strong> (62) 9 9999-9999</p>
                     <p><strong class="text-[10px]">Endereço:</strong> R. Maria Conceição, 245...</p>
                 ...
                 <dl class="space-y-2 text-sm">
                     ...
                     <div class="flex justify-between font-bold text-lg pt-2 border-t border-gray-200">
                         ...
                         <dd class="text-green-600">R$
                             {{ number_format($aluguel->valor_total_aluguel ?? 0.0, 2, ',', '.') }}</dd>
                     </div>
                 </dl>
             </div>
                 ...
                 @if ($aluguel->movimentos->count())
                     <ul class="space-y-2 text-sm">
                         @foreach ($aluguel->movimentos as $pagamento)
                             <li
                                 class="flex justify-between items-center border-b border-gray-100 pb-1 last:border-b-0">
                     ...
                     <div class="flex justify-between font-bold text-base mt-4 pt-2 border-t border-gray-200">
                         ...
                         <dd class="text-green-700">R$
                             {{ number_format($aluguel->movimentos->sum('valor_total_movimento'), 2, ',', '.') }}</dd>
                     </div>
                 @else
